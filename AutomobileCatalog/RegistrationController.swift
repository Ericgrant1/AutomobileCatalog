...
class RegistrationController: UIViewController {
    ...
    private lazy var fullnameContainerView: UIView = {
        let image = UIImage(systemName: "person", withConfiguration: UIImage.SymbolConfiguration(weight: .medium))
        let view = Utillities().inputContainerView(withImage: image!, textField: fullnameTextField)
        
        return view
    }()
    
    private lazy var usernameContainerView: UIView = {
        let image = UIImage(systemName: "person.crop.circle", withConfiguration: UIImage.SymbolConfiguration(weight: .medium))
        let view = Utillities().inputContainerView(withImage: image!, textField: usernameTextField)
    ...
    private let fullnameTextField: UITextField = {
        let tf = Utillities().textField(withPlaceholder: "Full Name")
        return tf
    }()
    
    private let usernameTextField: UITextField = {
        let tf = Utillities().textField(withPlaceholder: "Username")
        return tf
    }()
    
    private let alreadyHaveAccountButton: UIButton = {
        let button = Utillities().attributeButton("Already have an account?", " Log In")
    ...
    private let registrationButton: UIButton = {
        ...
        button.setTitleColor(.chineseBlack, for: .normal)
